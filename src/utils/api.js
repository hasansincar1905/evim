...
export const GET_SETTING_TRANSLATION = "get-settings-translation";
...
export const settingTranslationApi = {
  getSettingTranslation: ({ setting_id } = {}) => {
    return Api.get(GET_SETTING_TRANSLATION, {
      params: { setting_id },
    });
  },
};
  ...
  sendVerificationReq: ({ Details } = {}) => {
    ...
    if (Details && typeof Details === "object") {
      Object.entries(Details).forEach(([id, value]) => {
        ...
        // Properly format key as verification_field[id]
      });
    }
