...
import { getLanguageApi, getLimitsApi, sliderApi } from "@/utils/api";
import {
  CurrentLanguageData,
  setCurrentLanguage,
...
const RegisterModal = dynamic(() => import("../Auth/RegisterModal.jsx"), {
  ssr: false,
});
  ...
  return (
    <>
          ...
          <div className="left_side">
            ...
            <div className="select_search_cont search_lg">
              <div className="cat_select_wrapper">
                ...
                >
                  <Option value="ghjghjgj" title="dfhgdsgfgf">
                    vbcvbbvcbcvbv
                  </Option>
                  {cateData &&
              ...
              <div className="search_cont">
                ...
                <button onClick={handleSearchNav}>
                  <FaSearch size={14} />
      ...
      <RegisterModal
        ...
        OnHide={() => setIsRegisterModalOpen(false)}
      ...
      <LoginModal
        ...
        setIsLoginModalOpen={setIsLoginModalOpen}
        setIsRegisterModalOpen={openRegisterModal}
